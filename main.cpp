...
Microsoft::WRL::ComPtr <ID3D12DescriptorHeap> CreatDescriptoHeap(const Microsoft::WRL::ComPtr <ID3D12Device>& device, D3D12_DESCRIPTOR_HEAP_TYPE heapType, UINT numDescriptors, bool shaderVisible)
{
...
void UploadTextureData(Microsoft::WRL::ComPtr < ID3D12Resource> texture, const DirectX::ScratchImage& mipImage)
{
...
D3D_FEATURE_LEVEL_12_2,D3D_FEATURE_LEVEL_12_1,D3D_FEATURE_LEVEL_12_0
	...
	//ディスクリプタヒープの生成
	Microsoft::WRL::ComPtr<ID3D12DescriptorHeap> rtvDescriptorHeap = CreatDescriptoHeap(device.Get(), D3D12_DESCRIPTOR_HEAP_TYPE_RTV, 2, false);
	Microsoft::WRL::ComPtr<ID3D12DescriptorHeap> srvDescriptorHeap = CreatDescriptoHeap(device.Get(), D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, 128, true);
	//swapChainからresourceを引っ張ってくる
	Microsoft::WRL::ComPtr<ID3D12Resource> swapChaiResources[2] = { nullptr };
	...
	Microsoft::WRL::ComPtr<ID3D12DescriptorHeap> dsvDescriptorHeap = CreatDescriptoHeap(device.Get(), D3D12_DESCRIPTOR_HEAP_TYPE_DSV, 1, false);
	//DSVの設定
	...
	Microsoft::WRL::ComPtr<ID3D12Resource> transformtionMatrixResourceSprite = CreateBufferResource(device.Get(), sizeof(TransformationMatrix));
	...
	while (msg.message != WM_QUIT)
	{
		...
		else
		{
			...
			barrier.Transition.pResource = swapChaiResources[backBufferIndex].Get();
